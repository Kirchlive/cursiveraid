...
L:RegisterTranslations("enUS", function()
	...
	["Check spell cooldown before casting. Returns false if spell is on cooldown, allowing macro fallthrough to the next action."] = true,
	["Time threshold for refreshing DoTs when Dark Harvest is off cooldown. Ensures DoTs have enough duration before channeling Dark Harvest. Example: harvestrefresh=6"] = true,
		...
		["Health Bar Texture Desc"] = "Full path to the texture file like the default: Interface\\TargetingFrame\\UI-StatusBar",
		["Health Bar Spacing"] = true,
		["Debuff Icon Spacing"] = true,
		["Raid Icon Size"] = true,
		...
		-- Shared Debuffs v3.2 - Menu Structure
		["Raid Debuffs"] = true,
		["By Class"] = true,
		["Items/Weapons"] = true,
		["Armor Reduction"] = true,
		["Spell Vulnerability"] = true,
		["Weapon Procs"] = true,
		["Enable All"] = true,
		["Disable All"] = true,
		["Enable all debuffs in this category"] = true,
		["Disable all debuffs in this category"] = true,

		-- Shared Debuffs v3.2 - Debuff Names (new)
		...
		-- Shared Debuffs v3.2 - Display Labels
		["Shared Sunder Armor"] = true,
		["Shared Expose Armor"] = true,
		["Shared Faerie Fire"] = true,
		["Shared Curse of Recklessness"] = true,
		["Shared Curse of the Elements"] = true,
		["Shared Curse of Shadow"] = true,
		["Shared Curse of Tongues"] = true,
		["Shared Curse of Weakness"] = true,
		["Shared Fire Vulnerability"] = true,
		["Shared Winter's Chill"] = true,
		["Shared Shadow Vulnerability"] = true,
		["Shared Shadow Weaving"] = true,
		["Shared Spell Vulnerability"] = true,
		["Shared Armor Shatter"] = true,
		["Shared Thunderfury"] = true,
		["Shared Gift of Arthas"] = true,
		["Shared Demoralizing Shout"] = true,
		["Shared Demoralizing Roar"] = true,
		["Shared Thunder Clap"] = true,
		["Shared Mortal Strike"] = true,
		["Shared Wound Poison"] = true,
		["Shared Hunter's Mark"] = true,
		["Shared Freezing Trap"] = true,
		["Shared Scatter Shot"] = true,
		["Shared Wyvern Sting"] = true,
		["Shared Polymorph"] = true,
		["Shared Ignite"] = true,
		["Shared Hibernate"] = true,
		["Shared Shackle Undead"] = true,
		["Shared Mind Control"] = true,
		["Shared Psychic Scream"] = true,
		["Shared Expose Armor"] = true,
		["Shared Sap"] = true,
		["Shared Banish"] = true,
		["Shared Fear"] = true,
		["Shared Howl of Terror"] = true,
		["Shared Enslave Demon"] = true,
		["Shared Seduction"] = true,
		["Shared Intimidating Shout"] = true,
		["Shared Hammer of Justice"] = true,
		["Shared Judgement of Light"] = true,
		["Shared Judgement of Wisdom"] = true,
		["Shared Judgement of the Crusader"] = true,

		-- Shared Debuffs v3.2 - Tooltip Descriptions
		["Track other player's Sunder Armor on targets"] = true,
		["Track other player's Expose Armor on targets"] = true,
		["Track other player's Curse of Recklessness on targets"] = true,
		["Track other player's Curse of the Elements on targets"] = true,
		["Track other player's Curse of Shadow on targets"] = true,
		["Track other player's Curse of Tongues on targets"] = true,
		["Track other player's Curse of Weakness on targets"] = true,
		["Track other player's Fire Vulnerability on targets"] = true,
		["Track other player's Winter's Chill on targets"] = true,
		["Track other player's Shadow Vulnerability on targets"] = true,
		["Track other player's Shadow Weaving on targets"] = true,
		["Track other player's Spell Vulnerability (Nightfall) on targets"] = true,
		["Track Armor Shatter (Annihilator) on targets"] = true,
		["Track Thunderfury debuff on targets"] = true,
		["Track Gift of Arthas on targets"] = true,
		["Track other player's Demoralizing Shout on targets"] = true,
		["Track other player's Demoralizing Roar on targets"] = true,
		["Track other player's Thunder Clap on targets"] = true,
		["Track other player's Mortal Strike on targets"] = true,
		["Track other player's Wound Poison on targets"] = true,
		["Track other player's Hunter's Mark on targets"] = true,
		["Track other player's Freezing Trap on targets"] = true,
		["Track other player's Scatter Shot on targets"] = true,
		["Track other player's Wyvern Sting on targets"] = true,
		["Track other player's Polymorph on targets"] = true,
		["Track other player's Ignite on targets"] = true,
		["Track other player's Hibernate on targets"] = true,
		["Track other player's Shackle Undead on targets"] = true,
		["Track other player's Mind Control on targets"] = true,
		["Track other player's Psychic Scream on targets"] = true,
		["Track other player's Sap on targets"] = true,
		["Track other player's Banish on targets"] = true,
		["Track other player's Fear on targets"] = true,
		["Track other player's Howl of Terror on targets"] = true,
		["Track other player's Enslave Demon on targets"] = true,
		["Track other player's Seduction on targets"] = true,
		["Track other player's Intimidating Shout on targets"] = true,
		["Track other player's Hammer of Justice on targets"] = true,
		["Track other player's Judgement of Light on targets"] = true,
		["Track other player's Judgement of Wisdom on targets"] = true,
		["Track other player's Judgement of the Crusader on targets"] = true,
...
L:RegisterTranslations("zhCN", function()
	...
	["Check spell cooldown before casting. Returns false if spell is on cooldown, allowing macro fallthrough to the next action."] = "施法前检查冷却时间。如果法术正在冷却中则返回false，允许宏继续执行下一个动作.",
	["Time threshold for refreshing DoTs when Dark Harvest is off cooldown. Ensures DoTs have enough duration before channeling Dark Harvest. Example: harvestrefresh=6"] = "当黑暗收割冷却就绪时刷新DoT的时间阈值。确保DoT在引导黑暗收割前有足够的持续时间。示例：harvestrefresh=6.",
		...
		["Health Bar Texture"] = "生命条纹理",
		["Health Bar Texture Desc"] = "生命条纹理的完整路径，例如默认值：Interface\\TargetingFrame\\UI-StatusBar",
		["Health Bar Spacing"] = "生命条间距",
		["Debuff Icon Spacing"] = "减益图标间距",
		...
		["By Class"] = "按职业",
		["Items/Weapons"] = "物品/武器",
		["Armor Reduction"] = "护甲削减",
		["Spell Vulnerability"] = "法术易伤",
		["Weapon Procs"] = "武器触发",
		["Enable All"] = "全部启用",
		["Disable All"] = "全部禁用",
		["Enable all debuffs in this category"] = "启用此类别中的所有减益",
		["Disable all debuffs in this category"] = "禁用此类别中的所有减益",
		...
		["bonereaver's edge"] = "噬骨者之刃",
		["puncture armor"] = "穿刺护甲",
		["howl of terror"] = "恐惧嚎叫",
		["enslave demon"] = "奴役恶魔",
		["psychic scream"] = "心灵尖啸",
		["scatter shot"] = "驱散射击",
		["polymorph: rodent"] = "变形术：鼠",
